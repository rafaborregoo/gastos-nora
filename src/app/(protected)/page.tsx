  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Resumen mensual, balances pendientes y accesos rápidos para registrar movimientos."
        action={
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <Card>
          ...
          <p className="mt-3 text-2xl font-semibold sm:text-3xl">{formatCurrency(dashboard?.totalExpenses ?? 0)}</p>
        </Card>
        <Card>
          <p className="text-sm text-muted-foreground">Ingresos del mes</p>
          <p className="mt-3 text-2xl font-semibold sm:text-3xl">{formatCurrency(dashboard?.totalIncome ?? 0)}</p>
        </Card>
        <Card>
          <p className="text-sm text-muted-foreground">Balance</p>
          <p className="mt-3 text-2xl font-semibold sm:text-3xl">{formatCurrency(dashboard?.balance ?? 0)}</p>
        </Card>
        <Card>
          <p className="text-sm text-muted-foreground">Mi posición neta</p>
          <p className="mt-3 text-2xl font-semibold sm:text-3xl">{formatCurrency(currentBalance)}</p>
        ...
        <Card className="space-y-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Los registros más recientes del espacio activo.</p>
            </div>
